      ...
      <div className="aboutMe__container">
        ...
        <div className="aboutMe__info">
          ...
          <div className="aboutMe-text__container">
            ...
            <p className="aboutMe__text">
              Soy desarrolladora web frontend desde junio de 2019. La curiosidad por la programación me llevó al bootcamp de Adalab y ahora, tras meses formándome, estoy lista para dar lo mejor de mi misma y seguir creciendo dentro del sector tecnológico.
            </p>
            <p className="aboutMe__text">
